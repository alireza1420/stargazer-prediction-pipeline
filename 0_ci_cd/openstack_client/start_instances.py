...
instance_prod = nova.servers.create(name="stargazer_prod_server_"+str(identifier), image=image, flavor=flavor, key_name=keyName,userdata=userdata_prod, nics=nics,security_groups=secgroups)
instance_dev = nova.servers.create(name="stargazer_dev_server_"+str(identifier), image=image, flavor=flavor, key_name=keyName,userdata=userdata_dev, nics=nics,security_groups=secgroups)
