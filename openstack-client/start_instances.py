...
instance_prod = nova.servers.create(name="stargazer_prod_server"+str(identifier), image=image, flavor=flavor, key_name=keyName,userdata=userdata_prod, nics=nics,security_groups=secgroups)
